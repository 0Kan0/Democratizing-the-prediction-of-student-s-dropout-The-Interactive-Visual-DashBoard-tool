    ...
    def layout(self):
        ...
        return dbc.Container([
            dbc.Row([
                dbc.Col([
                    html.H3("Description"),
                    html.Div("This matrix represents the visualization of the performance of the algorithm used for prediction. Each square has a different meaning: "),
                    html.Div(""),
                    html.Div("- True positive (top left): It is predicted to be postive and it's true."),
                    html.Div("- False negative (top right): It is predicted to be negative and it's false."),
                    html.Div("- False positive (bottom left): It is predicted to be positive and it's false."),
                    html.Div("- True negative (bottom right): It is predicted to be negative and it's true."),
                    html.Div(""),
                    html.Div("The top squares show the dropout percentage and the down squares the non-dropout percentage."),
            ...
            dbc.Row([
                dbc.Col([
                    ...
                    html.Div("For this purpose, it is calculated the mean absolute SHAP value that shows how much a single feature impacts on the prediction."),
                    html.Div("You can check the feature label on the left side of the graph and the description on the right side."),
